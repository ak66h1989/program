...
def mline(request):
    ...
    # return render(request, 'myapp/c3.html', d)
    return render(request, 'myapp/testlist.html', d)
    # return render(request, 'myapp/dygraph.html', d)
...
def datatable(request):
    ...
    return render(request, 'myapp/datatable.html', d)
