...
for CO_ID in id:
    try:
            ...
            for SEASON in ['1']:
                ...
                try:
                    ...
                    if len(dup)>0:
                        ...
                        print(dupl)
                        dupl.to_csv('C:/Users/ak66h_000/OneDrive/webscrap/du2'+str(stat)+'.csv', index=False)
        ...
        path='C:/Users/ak66h_000/OneDrive/webscrap/incomedu/df'+CO_ID+'.csv'
...
df.to_csv('C:/Users/ak66h_000/OneDrive/webscrap/income.csv', index=False)
df=read_csv('C:/Users/ak66h_000/OneDrive/webscrap/income.csv', encoding='big5')
print(read_csv('C:/Users/ak66h_000/OneDrive/webscrap/du2.csv', encoding='big5'))
...
df0 = read_sql_query("SELECT * from `ifrs前後-綜合損益表`", conn).replace('', nan)
...
conn = connect('C:\\Users\\ak66h_000\\Documents\\mops.sqlite3')
c = conn.cursor()
# df0 = read_sql_query("SELECT * from `ifrs前後-綜合損益表`", conn)
# df0['季']=df0['季'].str[1].astype(int)
# df0['年']=df0['年'].astype(int)
