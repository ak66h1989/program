...
forweb['lnr'] = log(forweb['調整收盤價']/forweb['調整收盤價'].shift())
forweb['lnr025'] = log(forweb['調整收盤價'].shift(-5)/forweb['調整收盤價'])*48
forweb['lnr05'] = log(forweb['調整收盤價'].shift(-10)/forweb['調整收盤價'])*24
forweb['lnr1'] = log(forweb['調整收盤價'].shift(-20)/forweb['調整收盤價'])*12
forweb['lnr2'] = log(forweb['調整收盤價'].shift(-40)/forweb['調整收盤價'])*6
forweb['lnr3'] = log(forweb['調整收盤價'].shift(-60)/forweb['調整收盤價'])*4
forweb['lnr6'] = log(forweb['調整收盤價'].shift(-120)/forweb['調整收盤價'])*2
...
forweb['r025'] = (forweb['調整收盤價'].shift(-5)/forweb['調整收盤價'])**48-1
forweb['r05'] = (forweb['調整收盤價'].shift(-10)/forweb['調整收盤價'])**24-1
forweb['r1'] = (forweb['調整收盤價'].shift(-20)/forweb['調整收盤價'])**12-1
forweb['r2'] = (forweb['調整收盤價'].shift(-40)/forweb['調整收盤價'])**6-1
forweb['r3'] = (forweb['調整收盤價'].shift(-60)/forweb['調整收盤價'])**4-1
forweb['r6'] = (forweb['調整收盤價'].shift(-120)/forweb['調整收盤價'])**2-1
